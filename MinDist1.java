...
/*
Shorted distance between word 1 - Given array od words and two words. Find the minimum distance between them. 
Given that thw two words are always different.
*/ 
public class MinDist1{
    public static void main(String args[]){
        String words[] = {"leetcode", "practice", "makes", "perfect", "practice", "leetcode", "makes", 
        "practice", "makes", "perfect", "leetcode", "perfect"};
